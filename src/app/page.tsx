    ...
    <>
      {status === "loading" ? (
        ...
        >
          <form
            method="post"
            className="animate__animated animate__fadeInLeftBig bg-neutral-50 border-opacity-50 rounded px-5 pb-5 pt-40 md:p-5 w-full max-w-[700px] mx-auto shadow-sm h-screen md:h-[450px]"
